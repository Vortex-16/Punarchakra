            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 py-12 md:p-8 bg-white dark:bg-[#0a0a0a] relative transition-colors duration-500 min-h-screen">
                <div className="w-full max-w-[440px] space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <h2 className="text-2xl sm:text-3xl font-bold text-neutral-900 dark:text-white tracking-tight transition-colors duration-300">Login Now</h2>
                        <p className="text-sm font-medium text-neutral-500 dark:text-neutral-400 transition-colors duration-300">Welcome back! Please enter your details.</p>
                    </div>
