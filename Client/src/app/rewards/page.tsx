...
const leaderboard = [
    ...
    { rank: 3, name: "You", points: 2450, avatar: "ME" }, // User
        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-forest-green/10 text-forest-green rounded-xl font-bold">
                    ...
                    <span>{userStats.points} Points Available</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    <div className="relative z-10">
                        ...
                        <h2 className="text-2xl font-bold mt-1">{userStats.level}</h2>
                        <div className="mt-4">
                            <div className="flex justify-between text-xs mb-1 opacity-80">
                                <span>Progress</span>
                                <span>{userStats.points} / {userStats.nextLevel}</span>
                            </div>
                ...
                >
                    ...
                    <div className="flex justify-between items-end border-t border-gray-100 dark:border-gray-800 pt-4">
                        <div>
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{userStats.co2Saved}</p>
                            <p className="text-xs text-gray-400">CO2 Emissions Saved</p>
                        </div>
                        <div className="text-right">
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{userStats.itemsRecycled}</p>
                ...
                <div className="lg:col-span-2 bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 h-full">
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between items-center text-sm py-2 border-b border-gray-200 dark:border-gray-700 last:border-0">
                            <div>
                                <p className="font-medium text-gray-900 dark:text-white">Recycled Old Laptop</p>
                                <p className="text-xs text-gray-500">2 days ago • Bin #12</p>
                            </div>
                            <span className="font-bold text-forest-green">+500 pts</span>
                        </div>
                        <div className="flex justify-between items-center text-sm py-2 border-b border-gray-200 dark:border-gray-700 last:border-0">
                            <div>
                                <p className="font-medium text-gray-900 dark:text-white">Redeemed Amazon Voucher</p>
                                <p className="text-xs text-gray-500">1 week ago</p>
                            </div>
                            <span className="font-bold text-red-500">-1000 pts</span>
                        </div>
                    </div>
                </div>

                {/* Eco Tip Card */}
                <div className="bg-gradient-to-r from-blue-500 to-cyan-500 p-6 rounded-2xl text-white relative overflow-hidden h-full flex flex-col justify-center">
                    <div className="relative z-10">
