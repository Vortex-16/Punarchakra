...
export function ResultCard({ result, onReset, onVerification }: ResultCardProps) {
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-800 w-full max-w-md mx-auto relative overflow-hidden"
    >
